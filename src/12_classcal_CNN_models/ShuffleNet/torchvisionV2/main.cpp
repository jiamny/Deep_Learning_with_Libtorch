...
int main() {
     ...
     ShuffleNetV2_x0_5 net(num_classes);
     net->to(device);
     ...
     std::cout << device << std::endl;
   	 ...
   	 std::string model_file_name="./models/torchvisionV2_shufflenet.pt";
   	...
   	auto test_loader = torch::data::make_data_loader(
   	        std::move(test_set_transformed), torch::data::DataLoaderOptions()
   	                                             ...
   	                                             .enforce_ordering(true));
    // Model
    ShuffleNetV2_x0_5 model(classes.size());
    model->to(device);
    ...
    if( saveModel ) {
        ...
        model = ShuffleNetV2_x0_5(classes.size());
