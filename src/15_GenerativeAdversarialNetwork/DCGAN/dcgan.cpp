...
int main(int argc, const char* argv[]) {
  ...
  if( kRestoreFromCheckpoint ) {
    torch::load(generator, "./models/dcgan_generator-checkpoint.pt");
    torch::load(generator_optimizer, "./models/dcgan_generator-optimizer-checkpoint.pt");
    torch::load(discriminator, "./models/dcgan_discriminator-checkpoint.pt");
    torch::load(
        discriminator_optimizer, "./models/dcgan_discriminator-optimizer-checkpoint.pt");
  }
  ...
  for (int64_t epoch = 1; epoch <= kNumberOfEpochs; ++epoch) {
    ...
    for (torch::data::Example<>& batch : *data_loader) {
      ...
      if (batch_index % kCheckpointEvery == 0) {
        ...
        torch::save(generator, "./models/dcgan_generator-checkpoint.pt");
        torch::save(generator_optimizer, "./models/dcgan_generator-optimizer-checkpoint.pt");
        torch::save(discriminator, "./models/dcgan_discriminator-checkpoint.pt");
        torch::save(
            discriminator_optimizer, "./models/dcgan_discriminator-optimizer-checkpoint.pt");
