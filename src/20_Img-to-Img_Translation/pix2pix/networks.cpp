...
// ----------------------------------------------------------------------
UNet_GeneratorImpl::UNet_GeneratorImpl(size_t ngf, size_t img_size, bool no_dropout, size_t nz, size_t input_nc, size_t output_nc) {
    
    size_t feature = ngf;
    size_t num_downs = (size_t)(std::log2(img_size));
    bool use_dropout = !no_dropout;

    UNetBlockImpl blocks, fake;
    blocks = UNetBlockImpl({feature*8, feature*8}, nz, /*submodule_=*/fake, /*outermost_=*/false, /*innermost=*/true);
    ...
    blocks = UNetBlockImpl({input_nc, output_nc}, feature, /*submodule_=*/blocks, /*outermost_=*/true);
...
// ----------------------------------------------------------------------
PatchGAN_DiscriminatorImpl::PatchGAN_DiscriminatorImpl(size_t ndf, size_t input_nc, size_t output_nc, size_t n_layers){
