...
public:
	...
	void Predict(cv::Mat& image, const std::string& which_class, std::string pred_img_path);
private:
...
template <class Model>
void Segmentor<Model>::Predict(cv::Mat& image, const std::string& which_class, std::string pred_img_path) {
