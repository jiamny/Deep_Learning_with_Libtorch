...
Detector::Detector(const std::array<int64_t, 2> &_inp_dim, YOLOType type) {
    ...
    case YOLOType::YOLOv3:
    	std::cout << "yolov3\n";
        net = std::make_unique<Darknet>("src/26_Yolov3_deepsort/models/yolov3.cfg");
        net->load_weights("/media/hhj/localssd/DL_data/weights/yolo3/yolov3.weights");
        break;
    case YOLOType::YOLOv3_TINY:
    	std::cout << "yolov3-tiny\n";
        net = std::make_unique<Darknet>("src/26_Yolov3_deepsort/models/yolov3-tiny.cfg");
        net->load_weights("/media/hhj/localssd/DL_data/weights/yolo3/yolov3-tiny.weights");
        break;
    default:
        break;
    }
